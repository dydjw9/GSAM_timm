...
def main():
    ...
    scheduler = CosineScheduler(T_max=args.epochs*313, max_value=args.lr, min_value=0.0, optimizer=base_optimizer)
    ...
    optimizer = GSAM(params=model.parameters(), base_optimizer=base_optimizer, model=model, gsam_alpha=args.alpha, rho_scheduler=rho_scheduler, adaptive=False)
